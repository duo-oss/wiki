...
DSL 其实是 Domain Specific Language 的缩写，中文翻译为_领域特定语言_（下简称 DSL）；而与 DSL 相对的就是 GPL，这里的 GPL 并不是我们知道的开源许可证，而是 General Purpose Language 的简称，即_通用编程语言_，也就是我们非常熟悉的 Objective-C、Java、Python 以及 C 语言等等。
